...
<div class="row">
    <div class="col-md-12">
        <div class="text-center">
            <img src="img/putra.jpg" alt="Arya Saputra" width="160" class="rounded-circle">
            <table class="table mt-4" style="width:100%; margin:0 auto;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left" width="50%">Arya Saputra</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Tempat, Tanggal Lahir :</strong></td>
                        <td align="left" width="50%">Banjarmasin, 21 Juli 2003</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Telepon :</strong></td>
                        <td align="left" width="50%">0812 5631 1605</td>
                    </tr>
                    <tr>
